...
<Card.Text>
  <h6><b>Specialisation:</b> Orthopedic</h6>
  ...
  <h6><b>Qualifications:</b> MBBS (MAHE) , M.Surgery (UKM) , CMIA (NIOSH) , Board Certified Urologist (M’sia) ,
   ...
   <h6><b>Condition Consulted:</b> Acute injuries, Arthritis,Bursitis, Bursitis, Musculoskeletal cancer, Hematuria, Osteoporosis,
   Osteomyelitis,Osteomalacia, Orthopedic autoimmune diseases, Tendinitis, Pinched nerve Inguinal Hernia, Tenosynovitis, , Prostate Diseases,
   Chancroid, Obstruction, STD, Candidiasis, BPH and  Cancer </h6>
</Card.Text>
</Card.Body>
